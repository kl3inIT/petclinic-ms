package com.mss301.petclinic.products;
...
/**
 * Smoke test — verify Spring context khởi tạo + Liquibase chạy migration products.
...
class ProductsServiceApplicationTests extends AbstractPostgresIntegrationTest {
