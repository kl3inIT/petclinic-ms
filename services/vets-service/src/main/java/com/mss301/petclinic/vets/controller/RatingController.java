...
public class RatingController {
    ...
    @PostMapping
    @Operation(
            summary = "Add a one-time rating of a vet",
            description = "score 1-5 (out of range → 400 ProblemDetail). " +
                          ...
                          "Mỗi customer chỉ được đánh giá một lần cho mỗi vet; POST trùng → 400 " +
                          "error.already-rated. Unique (vet_id, customer_name) ở DB layer. " +
