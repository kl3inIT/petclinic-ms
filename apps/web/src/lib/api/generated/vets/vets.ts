...
/**
 * Tra cứu ngược vet theo mã liên kết billing. Không vet nào mang mã → 404.
 * @summary Get vet by billing-link id (vetBillId)
 */
export const getVetByBillId = (vetBillId: string, signal?: AbortSignal) => {
  return apiMutator<VetResponse>({
    url: `/api/v1/vets/by-bill/${vetBillId}`,
    method: 'GET',
    signal,
  });
};

export const getGetVetByBillIdQueryKey = (vetBillId?: string) => {
  return [`/api/v1/vets/by-bill/${vetBillId}`] as const;
};

export const getGetVetByBillIdQueryOptions = <
  TData = Awaited<ReturnType<typeof getVetByBillId>>,
  TError = ErrorType<unknown>,
>(
  vetBillId: string,
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getVetByBillId>>, TError, TData>
    >;
  },
) => {
  const { query: queryOptions } = options ?? {};

  const queryKey = queryOptions?.queryKey ?? getGetVetByBillIdQueryKey(vetBillId);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getVetByBillId>>> = ({
    signal,
  }) => getVetByBillId(vetBillId, signal);

  return { queryKey, queryFn, enabled: !!vetBillId, ...queryOptions } as UseQueryOptions<
    Awaited<ReturnType<typeof getVetByBillId>>,
    TError,
    TData
  > & { queryKey: DataTag<QueryKey, TData, TError> };
};

export type GetVetByBillIdQueryResult = NonNullable<
  Awaited<ReturnType<typeof getVetByBillId>>
>;
export type GetVetByBillIdQueryError = ErrorType<unknown>;

export function useGetVetByBillId<
  TData = Awaited<ReturnType<typeof getVetByBillId>>,
  TError = ErrorType<unknown>,
>(
  vetBillId: string,
...
>(
  ...
  const queryOptions = getGetVetByBillIdQueryOptions(vetBillId, options);
...
export const getGetVetByBillIdSuspenseQueryOptions = <
  TData = Awaited<ReturnType<typeof getVetByBillId>>,
  TError = ErrorType<unknown>,
>(
  vetBillId: string,
  options?: {
    query?: Partial<
      UseSuspenseQueryOptions<Awaited<ReturnType<typeof getVetByBillId>>, TError, TData>
    >;
  },
) => {
  const { query: queryOptions } = options ?? {};
...
export type GetVetByBillIdSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getVetByBillId>>
>;
export type GetVetByBillIdSuspenseQueryError = ErrorType<unknown>;

export function useGetVetByBillIdSuspense<
  TData = Awaited<ReturnType<typeof getVetByBillId>>,
  TError = ErrorType<unknown>,
>(
  vetBillId: string,
...
>(
  ...
  const queryOptions = getGetVetByBillIdSuspenseQueryOptions(vetBillId, options);
