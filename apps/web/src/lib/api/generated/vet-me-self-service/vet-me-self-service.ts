...
/**
 * Trả 404 nếu vet chưa upload photo. vetId resolve từ JWT claim.
 * @summary Avatar của vet đang login (metadata + presigned URL)
 */
export const getMyVetPhoto = (signal?: AbortSignal) => {
  return apiMutator<VetPhotoResponse>({
    url: `/api/v1/vets/me/photo`,
    method: 'GET',
    signal,
  });
};

export const getGetMyVetPhotoQueryKey = () => {
  return [`/api/v1/vets/me/photo`] as const;
};

export const getGetMyVetPhotoQueryOptions = <
  TData = Awaited<ReturnType<typeof getMyVetPhoto>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof getMyVetPhoto>>, TError, TData>
  >;
}) => {
  const { query: queryOptions } = options ?? {};

  const queryKey = queryOptions?.queryKey ?? getGetMyVetPhotoQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getMyVetPhoto>>> = ({
    signal,
  }) => getMyVetPhoto(signal);

  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<
    Awaited<ReturnType<typeof getMyVetPhoto>>,
    TError,
    TData
  > & { queryKey: DataTag<QueryKey, TData, TError> };
};

export type GetMyVetPhotoQueryResult = NonNullable<
  Awaited<ReturnType<typeof getMyVetPhoto>>
>;
export type GetMyVetPhotoQueryError = ErrorType<unknown>;

export function useGetMyVetPhoto<
  TData = Awaited<ReturnType<typeof getMyVetPhoto>>,
  TError = ErrorType<unknown>,
>(
  options: {
...
>(
  ...
  const queryOptions = getGetMyVetPhotoQueryOptions(options);
...
export const getGetMyVetPhotoSuspenseQueryOptions = <
  TData = Awaited<ReturnType<typeof getMyVetPhoto>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: Partial<
    UseSuspenseQueryOptions<Awaited<ReturnType<typeof getMyVetPhoto>>, TError, TData>
  >;
}) => {
  const { query: queryOptions } = options ?? {};
...
export type GetMyVetPhotoSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getMyVetPhoto>>
>;
export type GetMyVetPhotoSuspenseQueryError = ErrorType<unknown>;

export function useGetMyVetPhotoSuspense<
  TData = Awaited<ReturnType<typeof getMyVetPhoto>>,
  TError = ErrorType<unknown>,
>(
  options: {
...
>(
  ...
  const queryOptions = getGetMyVetPhotoSuspenseQueryOptions(options);
...
/**
 * Multipart field 'file'. Max 10MB. Content-type: image/jpeg|png|webp. Mỗi lần đổi ảnh reset status PENDING — chờ STAFF/ADMIN duyệt mới hiển thị public.
 * @summary Upload/replace avatar của vet đang login (idempotent)
 */
export const uploadMyVetPhoto = (
  uploadMyVetPhotoBody: BodyType<UploadMyVetPhotoBody>,
) => {
  const formData = new FormData();
  formData.append(`file`, uploadMyVetPhotoBody.file);
...
export const getUploadMyVetPhotoMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof uploadMyVetPhoto>>,
    TError,
    { data: BodyType<UploadMyVetPhotoBody> },
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof uploadMyVetPhoto>>,
  ...
  TContext
> => {
  const mutationKey = ['uploadMyVetPhoto'];
  ...
  > = (props) => {
    ...
    return uploadMyVetPhoto(data);
  };

  return { mutationFn, ...mutationOptions };
};

export type UploadMyVetPhotoMutationResult = NonNullable<
  Awaited<ReturnType<typeof uploadMyVetPhoto>>
>;
export type UploadMyVetPhotoMutationBody = BodyType<UploadMyVetPhotoBody>;
export type UploadMyVetPhotoMutationError = ErrorType<unknown>;

/**
 * @summary Upload/replace avatar của vet đang login (idempotent)
 */
export const useUploadMyVetPhoto = <TError = ErrorType<unknown>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof uploadMyVetPhoto>>,
      TError,
  ...
  TContext
> => {
  const mutationOptions = getUploadMyVetPhotoMutationOptions(options);

  return useMutation(mutationOptions, queryClient);
};
/**
 * @summary Xóa avatar của vet đang login
 */
export const deleteMyVetPhoto = () => {
  return apiMutator<void>({ url: `/api/v1/vets/me/photo`, method: 'DELETE' });
};

export const getDeleteMyVetPhotoMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof deleteMyVetPhoto>>,
    TError,
    void,
    TContext
  >;
  ...
  TContext
> => {
  const mutationKey = ['deleteMyVetPhoto'];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      'mutationKey' in options.mutation &&
      options.mutation.mutationKey
  ...
  const mutationFn: MutationFunction<
    ...
    void
  > = () => {
    return deleteMyVetPhoto();
  };

  return { mutationFn, ...mutationOptions };
};

export type DeleteMyVetPhotoMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteMyVetPhoto>>
>;

export type DeleteMyVetPhotoMutationError = ErrorType<unknown>;

/**
 * @summary Xóa avatar của vet đang login
 */
export const useDeleteMyVetPhoto = <TError = ErrorType<unknown>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof deleteMyVetPhoto>>,
      TError,
  ...
  TContext
> => {
  const mutationOptions = getDeleteMyVetPhotoMutationOptions(options);
