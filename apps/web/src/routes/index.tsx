...
function Hero({ ctaHref }: { ctaHref: string }) {
  return (
    <section id="home" className="relative overflow-hidden px-6 pt-12 pb-24 sm:pt-16">
      {/* paw decorations */}
      <PawDecor className="top-20 left-6 text-primary/30" rotate={-15} />
      <PawDecor className="top-44 left-20 text-primary/20" rotate={20} size="sm" />
      <PawDecor className="top-16 right-12 text-primary/30" rotate={25} />
      <PawDecor className="top-40 right-32 text-primary/20" rotate={-10} size="sm" />

      <div className="mx-auto max-w-5xl text-center">
        <p className="mb-3 text-sm font-medium tracking-wide text-primary/80">
          Được pet-owner tin tưởng từ năm 2010
        </p>
        <h1 className="text-4xl leading-tight font-extrabold tracking-tight text-balance text-foreground sm:text-5xl md:text-6xl lg:text-7xl">
          CHĂM SÓC THÚ CƯNG
          <br />
          <span className="text-primary">NHƯ NGƯỜI THÂN</span>
        </h1>
        <p className="mx-auto mt-6 max-w-xl text-base text-muted-foreground sm:text-lg">
          Đội ngũ bác sĩ giàu kinh nghiệm, cơ sở vật chất hiện đại và hệ thống đặt lịch
          trực tuyến 24/7 cho thú cưng của bạn.
        </p>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="text-center">
          <div className="mb-3 flex items-center justify-center gap-2 text-primary">
            ...
            <span className="text-sm font-semibold tracking-wide uppercase">Dịch vụ</span>
            <PawPrint className="size-5" />
          </div>
          <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl">
    ...
    <section id="contact" className="px-6 pb-20">
      <div className="mx-auto max-w-6xl overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-primary to-[#6e64b9] p-10 text-center text-white shadow-xl sm:p-14">
        ...
        <p className="mx-auto mt-3 max-w-xl text-white/90">
          Chọn thú cưng, chọn bác sĩ, chọn thời gian — chúng tôi lo phần còn lại. Bạn sẽ
